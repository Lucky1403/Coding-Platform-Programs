...
class Solution {
    ...
    public void  AlternativeyMerge(Node head1, Node head2)
    {
    ...
    public Node copyRandomList(Node head1) {
        Node head2 = deepCopy(head1); // Creating deep copy without random connections

        AlternativeyMerge(head1, head2);
